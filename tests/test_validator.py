...
from submitter import micado_validations as validations
...
class TestValidation(unittest.TestCase):
    ...
    def test_repository_is_defined_validation(self):
        ...
        self.assertTrue(error in validations.validate_repositories(bad_node, self.bad_tpl))
    ...
    def test_custom_type_requirement_list_validation(self):
        ...
        self.assertTrue(error in validations.validate_requirements(bad_node, self.good_tpl))
    ...
    def test_relationship_is_defined_validation(self):
        ...
        self.assertTrue(error in validations.validate_relationships(bad_node, self.good_tpl))
    ...
    def test_node_relationship_property_exists_validation(self):
        ...
        self.assertTrue(error in validations.validate_relationship_properties(bad_node, self.good_tpl))
