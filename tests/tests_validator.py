...
class TestValidation(unittest.TestCase):
    ...
    def test_good_validation_returns_good(self):
        ...
        self.assertTrue(msg in self.v.validation(good_tpl))

    def test_bad_validation_raises_error(self):
        with self.assertRaises(MultiError):
            self.v.validation(self.bad_tpl)
    ...
    def test_repository_is_defined_validation(self):
        ...
        self.assertTrue(error in self.v.validate_repositories(bad_node, bad_repo))
    ...
    def test_custom_type_requirement_list_validation(self):
        ...
        self.assertTrue(error in self.v.validate_requirements(bad_node))
    ...
    def test_relationship_is_defined_validation(self):
        ...
        self.assertTrue(error in self.v.validate_relationships(bad_node))
    ...
    def test_node_relationship_property_exists_validation(self):
        ...
        self.assertTrue(error in self.v.validate_relationship_properties(bad_node))
