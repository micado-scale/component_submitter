...
This is the constructor. Adaptor devs must allow for 2 parameters. The
``adaptor_id`` (required), which will be generated by the submitter engine, and the
and the ``template`` (optional) as a TOSCA Parser object.
